...
- Candidate run: `prosperity_rust_backtester/runs/round2-ash-exec-overlay-v01-day0-day0/candidate`
- Baseline run: `prosperity_rust_backtester/runs/round2-ash-exec-overlay-v01-day0-day0/baseline`
- Same dataset signature: `True`

## Headline Deltas

- `total_pnl`: candidate `102726.0` vs baseline `102777.0` (delta `-51.0`)
- `total_drawdown`: candidate `1803898.0` vs baseline `1803898.0` (delta `0.0`)
- `total_own_trades`: candidate `900` vs baseline `912` (delta `-12.0`)

## Product Outcome Deltas

- `ASH_COATED_OSMIUM.pnl` delta `-51.0`
- `INTARIAN_PEPPER_ROOT.pnl` delta `0.0`

## Likely Cause Categories

- `fair_value` delta_score `0.00`. Candidate: combined fill edge h5=4.864, total_pnl=102726.0. Baseline: combined fill edge h5=4.812, total_pnl=102777.0.
- `taking_thresholds` delta_score `0.00`. Candidate: aggressive_qty=1903, aggressive_edge_h5=1.421. Baseline: aggressive_qty=1940, aggressive_edge_h5=1.369.
- `passive_fill_quality` delta_score `0.00`. Candidate: passive_qty=2750, passive_edge_h5=7.247. Baseline: passive_qty=2745, passive_edge_h5=7.245.
