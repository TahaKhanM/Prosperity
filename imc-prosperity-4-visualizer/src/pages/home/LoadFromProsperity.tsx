...
export function LoadFromProsperity(): ReactNode {
  ...
  const now = Date.now();
  const rounds = [
    { value: 'ROUND0', label: 'Tutorial', openFrom: '2026-03-16T11:00:00.000Z' },
    { value: 'ROUND1', label: 'Round 1', openFrom: '2026-04-14T11:00:00.000Z' },
    { value: 'ROUND2', label: 'Round 2', openFrom: '2026-04-17T11:00:00.000Z' },
    { value: 'ROUND3', label: 'Round 3', openFrom: '2026-04-24T11:00:00.000Z' },
    { value: 'ROUND4', label: 'Round 4', openFrom: '2026-04-26T11:00:00.000Z' },
    { value: 'ROUND5', label: 'Round 5', openFrom: '2026-04-28T11:00:00.000Z' },
  ].map(round => {
