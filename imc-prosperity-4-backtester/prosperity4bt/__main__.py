...
def cli(
    ...
    vis: Annotated[bool, Option("--vis", help="Open backtest results in the Prosperity visualizer when done.")] = False,
    ...
    data: Annotated[Optional[Path], Option(help="Path to data directory. Must contain round directories with prices and trades CSVs.", show_default=False, exists=True, file_okay=False, dir_okay=True, resolve_path=True)] = None,
