...
def trade_ash(
    ...
    medium_one_sided_sell_follow = (
        sell_follow_signal and temp_position > -max(46, soft_cap + 24)
    )
    wide_one_sided_sell_follow = (
        wide_sell_follow_signal
        and temp_position > -max(34, soft_cap + 14)
        and not (progress >= 0.88 and temp_position <= -18)
    )
    one_sided_sell_follow = medium_one_sided_sell_follow or wide_one_sided_sell_follow
    ...
    elif medium_one_sided_sell_follow:
        prefer_inside_buy = False
        prefer_inside_sell = True
        quote_fair = min(quote_fair, current_mid - 0.4)
    elif wide_one_sided_sell_follow:
        prefer_inside_buy = False
        prefer_inside_sell = True
        quote_fair = min(quote_fair, current_mid - 0.18)
