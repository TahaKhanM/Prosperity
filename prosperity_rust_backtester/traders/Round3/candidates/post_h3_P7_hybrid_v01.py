"""P7 hybrid: baseline passive MM floor + HYDROGEL anchor band OVERLAY at full cap.

Keeps proven +8k baseline while adding curve-shape long/short exposure on HYDROGEL
at band extremes. If price hits 9985 we buy up to cap 200 (on top of MM). If 10015
we sell. Passive MM still runs inside the band for spread capture.
"""
import json, math
...
BAND_IN = 15; BAND_OUT = 5; BAND_ACC_SIZE = 60
