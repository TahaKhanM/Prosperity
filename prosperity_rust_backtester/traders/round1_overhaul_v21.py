...
def trade_ash(
    ...
    clear_reference = ASH_ANCHOR + 0.55 * clamp(fair - ASH_ANCHOR, -6.0, 6.0)
    ...
    if spread >= 21:
        buy_sizes = [16, 20] if not shock else [12, 15]
        sell_sizes = [16, 20] if not shock else [12, 15]
    elif spread >= 19:
        buy_sizes = [15, 18] if not shock else [11, 14]
        sell_sizes = [15, 18] if not shock else [11, 14]
    elif spread >= 18:
        buy_sizes = [13, 16] if not shock else [10, 12]
        sell_sizes = [13, 16] if not shock else [10, 12]
    else:
