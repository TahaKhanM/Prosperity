"""Probe 2: r4_otm_ac1_retune - re-tune OTM AC1 fade K constants.

Sole change vs r4_baseline_v15: AC1_FADE_K_5300/5400/5500 are bumped to match
R4 measured |AC1| (Phase 1 sub-agent: -0.214 / -0.249 / -0.242).

Pre-registered values (R4-V5300-B07 / V5400-B07 / V5500-B07):
  AC1_FADE_K_5300 = 0.21  (was 0.12)
  AC1_FADE_K_5400 = 0.25  (was 0.15)
  AC1_FADE_K_5500 = 0.24  (was 0.15)

Everything else identical to v15 baseline.
...
AC1_FADE_K_5300 = 0.21   # was 0.12 in v15 (R4-V5300-B07: re-tune to |AC1|)
AC1_FADE_K_5400 = 0.25   # was 0.15 in v15 (R4-V5400-B07)
AC1_FADE_K_5500 = 0.24   # was 0.15 in v15 (R4-V5500-B07)
AC1_FADE_CAP = 0.5
