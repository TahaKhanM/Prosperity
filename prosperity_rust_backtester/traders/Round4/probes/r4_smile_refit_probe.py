"""Probe 5: r4_smile_refit - R4-CHAIN-02 convexity refit standalone.

Identical to r4_baseline_v15_probe except for two voucher-smile constants:
  SMILE_A2_BASE          : 7.21  -> 7.62
  SMILE_A2_DRIFT_PER_DAY : 0.815 -> 1.62

The retuned values match the day-3 R4 historical convexity. v15's stale
(R3-fit) smile was strongest at TTE 8d and decayed away from observed
shape by TTE 5d (R4 day-3). This probe tests whether updating only the
convexity helps voucher PnL on day-3 without breaking day-1/2.

No other constants change. The contract and traderData "smile" shape are
preserved.

Pre-registered: pure constants change. No tuning to BT.
...
SMILE_A2_BASE = 7.62           # was 7.21 in v15 (R4-CHAIN-02 refit)
SMILE_A2_DRIFT_PER_DAY = 1.62  # was 0.815 in v15 (R4-CHAIN-02 refit)
