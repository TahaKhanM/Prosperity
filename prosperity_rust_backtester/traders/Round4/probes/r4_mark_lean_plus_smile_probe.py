"""Probe 6: r4_mark_lean_plus_smile - mark-lean stack + R4-CHAIN-02 smile refit.

Combines:
  - Probe 1: per-product Mark-conditional lean stack on HYD/VFE.
  - Probe 5: R4 day-3 convexity refit (SMILE_A2_BASE, SMILE_A2_DRIFT_PER_DAY).

These are the two "confirmed/highest-EV cheap changes" on top of v15.
Each component is pre-registered identically to its standalone probe.
