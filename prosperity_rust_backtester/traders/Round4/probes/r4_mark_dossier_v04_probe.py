"""Probe: r4_mark_dossier_v04 — Mark 67 weight reduction for VFE down-day risk.

v03 came in at +973 / 3-day with day-3 still -1,419 (VFE drift down day).
The Mark 67 fast-decay copy was riding +VFE into a falling market on day-3.

Changes vs v03:
- Reduce VFE_W_M67 from 0.50 → 0.30 (less aggressive +VFE lean on Mark 67
  prints; still active but smaller magnitude).
- Add a SOFT-DECAY EMA on VFE to avoid leaning into prolonged downward drift.
  Specifically: track the trailing 100-tick mid drift and reduce the +VFE
  Mark 67 contribution if recent drift is sharply negative.
...
VFE_W_M67 = 0.30            # reduced from v03's 0.50 to mute down-day risk
