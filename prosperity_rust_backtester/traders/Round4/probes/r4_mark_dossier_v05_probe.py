"""Probe: r4_mark_dossier_v05 — Mark 67 disabled, isolate Mark 14/38/49 effect.

Diagnostic variant. v04 still saw VFE day-3 at -4,428 vs v01's -2,995.
Hypothesis: Mark 67's +VFE copy keeps leaning long into the day-3 drift
even at reduced weight. v05 sets VFE_W_M67 = 0.0 to isolate the rest of
the Mark stack on VFE and verify the rest is stable.

Changes vs v04:
- VFE_W_M67 = 0.0 (disabled).
- Everything else same as v04.
...
VFE_W_M67 = 0.0             # disabled to isolate effect
