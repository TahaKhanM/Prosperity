"""Round 2 candidate: baseline Pepper carry shell with richer refill and late recycle."""
...
def trade_pepper(
    ...
    for ask in sorted(depth.sell_orders):
        ...
        if refill_guard_active:
            ...
            inventory_reset = temp_position <= max(62 if strict_refill_guard else 64, target_long - 8)
