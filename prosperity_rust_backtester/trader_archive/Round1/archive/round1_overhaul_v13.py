...
def trade_ash(
    ...
    take_edge = 2.25 if not shock else 1.75
    if anchor_gap >= 7.0:
        take_edge += 0.45
    clear_edge = 0.5
    ...
    buy_prices = [
        math.floor(quote_fair - 4.0),
        math.floor(quote_fair - 6.0),
    ]
    sell_prices = [
        math.ceil(quote_fair + 4.0),
        math.ceil(quote_fair + 6.0),
    ]
    buy_sizes = [9, 11] if not shock else [7, 9]
    sell_sizes = [9, 11] if not shock else [7, 9]
