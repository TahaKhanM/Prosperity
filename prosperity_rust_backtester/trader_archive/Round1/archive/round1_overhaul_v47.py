...
def trade_ash(
    ...
    if spread >= 21:
        buy_sizes = [12, 8] if not shock else [10, 7]
        sell_sizes = [12, 8] if not shock else [10, 7]
    elif spread >= 19:
        buy_sizes = [11, 8] if not shock else [9, 7]
        sell_sizes = [11, 8] if not shock else [9, 7]
    elif spread >= 18:
        buy_sizes = [10, 7] if not shock else [8, 6]
        sell_sizes = [10, 7] if not shock else [8, 6]
    else:
        buy_sizes = [8, 5] if not shock else [7, 4]
        sell_sizes = [8, 5] if not shock else [7, 4]
