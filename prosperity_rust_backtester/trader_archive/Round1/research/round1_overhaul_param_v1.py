...
ASH_DYNAMIC_WT = env_float("ASH_DYNAMIC_WT", 0.55)
ASH_TAKE_EDGE_NORMAL = env_float("ASH_TAKE_EDGE_NORMAL", 1.75)
ASH_TAKE_EDGE_SHOCK = env_float("ASH_TAKE_EDGE_SHOCK", 1.25)
ASH_SOFT_CAP_EARLY = env_int("ASH_SOFT_CAP_EARLY", 20)
ASH_SOFT_CAP_LATE = env_int("ASH_SOFT_CAP_LATE", 12)
ASH_SOFT_CAP_SWITCH = env_float("ASH_SOFT_CAP_SWITCH", 0.18)
...
def ash_fair_and_state(
    ...
    fair = (1.0 - ASH_DYNAMIC_WT) * anchored_fair + ASH_DYNAMIC_WT * dynamic_fair
...
def trade_ash(
    ...
    soft_cap = ASH_SOFT_CAP_EARLY if progress < ASH_SOFT_CAP_SWITCH else ASH_SOFT_CAP_LATE

    anchor_gap = abs(current_mid - ASH_ANCHOR)
    take_edge = ASH_TAKE_EDGE_NORMAL if not shock else ASH_TAKE_EDGE_SHOCK
    clear_edge = 0.5
